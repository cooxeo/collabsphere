...
module.exports = {
	...
	theme: {
	  ...
	  fontSize: {
		...
		'heading1-semibold': ["36px", { lineHeight: "140%", fontWeight: "600" }],
		'heading2-bold': ["30px", { lineHeight: "140%", fontWeight: "700" }],
		'heading2-semibold': ["30px", { lineHeight: "140%", fontWeight: "600" }],
		...
		'body1-bold': ["18px", { lineHeight: "140%", fontWeight: "700" }],
		...
		'base1-semibold': ["16px", { lineHeight: "140%", fontWeight: "600" }],
